            ...
            <Accordion>
              <AccordionItem key="1" aria-label="Ping Pong" title="Ping Pong">
                <EventUACJ
                  ...
                  qr={`${process.env.PUBLIC_URL}/Photos/Logos/QR's/PingPong.png`}
                />
              </AccordionItem>
              ...
              <EventUACJ
                  ...
                  qr={`${process.env.PUBLIC_URL}/Photos/Logos/QR's/FutBol.png`}
                />
              </AccordionItem>
            </Accordion>
          </CategoryUACJ>
            ...
            <Accordion>
              <AccordionItem key="1" aria-label="Mouseke-olimpiadas" title="Mouseke-olimpiadas">
                <EventUACJ
                  ...
                  qr={`${process.env.PUBLIC_URL}/Photos/Logos/QR's/MouseK.png`}
                />
              </AccordionItem>
              ...
              <AccordionItem key='3' aria-label='Concurso Catapulta' title='Concurso Catapulta'>
                <EventUACJ
                  link={`${process.env.PUBLIC_URL}/Files/convocatoria concurso catapultas  ene_jun 2024_1.pdf`}
                  info={'El Instituto de Ingeniería y Tecnología, junto con la Rama estudiantil ASQ-UACJ, invita a estudiantes universitarios a participar en el concurso La Catapulta, que busca fomentar el aprendizaje en estadística industrial y calidad. Los equipos de 4 a 6 integrantes analizarán y optimizarán el rendimiento de una catapulta en dos fases. El evento se llevará a cabo el 6 de mayo de 2024, otorgando premios en efectivo a los mejores proyectos.'}
                  qr={`${process.env.PUBLIC_URL}/Photos/Logos/QR's/Catapulta.png`}
                />
              </AccordionItem>
            </Accordion>
          </CategoryUACJ>
